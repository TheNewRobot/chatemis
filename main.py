...
def start_listening():
        ...
        intro = "Say 'keyboard' for keyboard input or say 'voice' for voice input:"
        while True:
                print_and_speak(intro)
                recording = sd.rec(int(wait_for_speech * freq),
